                ...
                <div class='box-body'>
                  ...
                  <?php
                    ...
                    echo "<table class='table table-striped table-condensed'>
                      <tr><td width='190px'>Nama Toko / Reseller</td>                <td> : <b>".stripslashes($res[nama_reseller])."</b></td></tr>
                    ...
                    echo "<tr class='alert alert-danger'>
                          ...
                          echo form_open($this->router->fetch_class().'/bayar_bonus');
                          echo "<input type='hidden' value='$id_reseller' name='idk'>
                                ...
                                <a class='btn btn-success btn-sm' style='margin-top:-5px' href='".base_url().$this->router->fetch_class()."/history_referral'>History</a>
                                <a class='btn btn-default btn-sm' style='margin-top:-5px' href='".base_url().$this->router->fetch_class()."/keuangan'>Kembali</a>
                                </td></tr>";
                          echo form_close();
                      echo "</table>";
                                        ...
                                        <td>";
                                            ...
                                            foreach ($rew->result_array() as $re) {
                                              ...
                                              if ($cek_reward->num_rows()<=0){
                                                echo " <a title='Bayarkan Reward ini' href='".base_url().$this->router->fetch_class()."/bayar_reward/$id_reseller/$re[id_reward]/$bulan' onclick=\"return confirm('Apa anda yakin untuk Reward ini sudah dibayarkan?')\"><span class='fa fa-check-square'></span></a>";
                                              }
                                              echo "<br>";
                                              $nomor++;
                                            }
