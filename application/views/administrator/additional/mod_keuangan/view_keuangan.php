                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td style='color:red'>".stripslashes($row[referral])."</td>
                              ...
                              <td><center>
                                ...
                                <a class='btn btn-info btn-xs' title='Bayarkan Bonus Rerral' href='".base_url().$this->router->fetch_class()."/bayar_bonus/$row[id_reseller]'><span class='glyphicon glyphicon-ok'></span> Bayar</a>
                              </center></td>
                          </tr>";
                      $no++;
                    }
