      <div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  ...
                  <a class='pull-right btn btn-warning btn-sm' href='<?php echo base_url()."".$this->router->fetch_class();?>/konsumen'>Kembali</a>
                </div>
                <div class='box-body'>
                      ...
                      <div role='tabpanel' class='tab-pane fade active in' id='profile' aria-labelledby='profile-tab'>
                          <div class='col-md-6'>
                            ...
                            <tbody>
                              ...
                              <tr><th scope='row'>Nama Lengkap</th> <td><?php echo stripslashes($rows['nama_lengkap'])?></td></tr>
