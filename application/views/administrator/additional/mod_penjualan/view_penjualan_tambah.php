            <div class="col-xs-12">  
              <div class="box">
                ...
                <?php 
                  ...
                  echo form_open_multipart($this->router->fetch_class().'/tambah_penjualan',$attributes); 
                ...
                ?>
                    ...
                    <?php 
                        echo "<tr>
                                ...
                                <td><button type='submit' name='submit' class='btn btn-success  btn-xs'><span class='glyphicon glyphicon-ok' aria-hidden='true'></span></button>
                                    <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url().$this->router->fetch_class()."/tambah_penjualan'><span class='glyphicon glyphicon-remove'></span></a>
                                </td>
                              </tr>";
                      ?>
                    <tbody>
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>
                                <a class='btn btn-warning btn-xs' title='Edit Data' href='".base_url().$this->router->fetch_class()."/tambah_penjualan/$row[id_penjualan_detail]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url().$this->router->fetch_class()."/delete_penjualan_tambah_detail/$row[id_penjualan_detail]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </td>
                          </tr>";
                      $no++;
                    }
