                      ...
                      <div role='tabpanel' class='tab-pane fade active in' id='profile' aria-labelledby='profile-tab'>
                          <div class='col-md-12'>
                            ...
                            <tbody>
                              ...
                              <tr><th scope='row'>Nama Reseller</th> <td><?php echo stripslashes($rows['nama_reseller']);?></td></tr>
                              <tr><th scope='row'>Jenis Kelamin</th> <td><?php echo $rows['jenis_kelamin']?></td></tr>
                              <tr><th scope='row'>Kota</th> <td><?php echo stripslashes($ko['nama_kota'])?></td></tr>
                              <tr><th scope='row'>Alamat Lengkap</th> <td><?php echo stripslashes($rows['alamat_lengkap'])?></td></tr>
                              ...
                              <tr><th scope='row'>Referral</th> <td><?php echo stripslashes($rows['referral'])?></td></tr>
                      ...
                      <div role='tabpanel' class='tab-pane fade' id='pembelian' aria-labelledby='pembelian-tab'>
                          <div class='col-md-12'>
                            ...
                            <?php 
                              ...
                              echo "<tr><td>$no</td>
                                        <td><a href='".base_url().$this->router->fetch_class()."/detail_penjualan/$row[id_penjualan]'>$row[kode_transaksi]</a></td>
                          ...
                          <div class='col-md-12'>
                            ...
                            <?php 
                              ...
                              echo "<tr><td>$no</td>
                                        ...
                                        <td><a href='".base_url().$this->router->fetch_class()."/detail_konsumen/$row[id_konsumen]'>$row[nama_lengkap]</a></td>
                                        <td>$row[waktu_transaksi]</td>
                                        <td>$proses</td>
                                        <td style='color:red;'>Rp ".rupiah($total['total'])."</td>
                                    </tr>";
                      ...
                      <div role='tabpanel' class='tab-pane fade' id='keuangan' aria-labelledby='keuangan-tab'>
                          <div class='col-md-12'>
                              ...
                              echo "<table class='table table-striped table-condensed'>
                                <tr>
                                  <td width='190px'>Belanja ke Perusahaan</td>                
                                  <td> : Rp ".rupiah($pembelian['total'])."</td>
                                </tr>
                                <tr>
                                  <td>Penjualan Produk Perusahaan</td>                        
                                  <td> : Rp ".rupiah($penjualan_perusahaan['total'])." (".rupiah($penjualan_perusahaan['produk'])." Produk)</td>
                                </tr>
                                <tr>
                                  <td>Modal Produk Perusahaan</td>                            
                                  <td> : Rp ".rupiah($modal_perusahaan['total'])."</td>
                                </tr>
                                <tr>
                                  <td>Penjualan Produk Pribadi</td>                           
                                  <td> : Rp ".rupiah($penjualan['total'])."</td>
                                </tr>
                                <tr>
                                  <td>Modal Produk Pribadi</td>                               
                                  <td> : Rp ".rupiah($modal_pribadi['total'])."</td>
                                </tr>
                                <tr class='success'>
                                <td>Keuntungan </td>
