<div class='col-md-12'>
  <div class='box box-info'>
    <div class='box-header with-border'>
      ...
      <a class='pull-right btn btn-warning btn-sm' href='<?php echo base_url().$this->router->fetch_class();?>/supplier'>Kembali</a>
    </div>
    <div class='box-body'>
      <table class='table table-condensed table-bordered'>
        <tbody>
          <tr bgcolor='#e3e3e3'><th rowspan='14' width='110px'><center><?php echo "<img style='border:1px solid #cecece; height:85px; width:85px' src='".base_url()."asset/foto_user/avatar_default.png' class='img-circle img-thumbnail'>"; ?></center></th></tr>
