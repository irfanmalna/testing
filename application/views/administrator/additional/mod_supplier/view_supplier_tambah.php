<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/tambah_supplier',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input class='form-control' type='email' name='e'></td></td>
                    </tr>
                    <tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/supplier'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
                  </div>
            </div>";
