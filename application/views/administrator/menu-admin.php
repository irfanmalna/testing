        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <?php 
                    ...
                    */
                    ...
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/pembayaran_reseller'><i class='fa fa-circle-o'></i> Pembayaran ke Reseller</a></li>";
                    }
              ...
              <li class="treeview">
                <a href="#"><i class="fa fa-circle-o"></i> Voucher <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                <ul class="treeview-menu">
                <?php
                if($this->session->level=='admin'){
                  echo '<li class="treeview">
                          <a href="'.base_url().$this->uri->segment(1).'/voucher"><i class="fa fa-circle-o"></i> Data Voucher</a>
                        </li>';
                        /*
                  echo  '<li class="treeview">
                          <a href="'.base_url().$this->uri->segment(1).'/tagihan_voucher"><i class="fa fa-circle-o"></i> Tagihan Voucher</a>
                        </li>';
                        */
                }
                ?>
            ...
            <li class="treeview">
              ...
              <?php
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/tagberita'><i class='fa fa-circle-o'></i> Menu Tag</a></li>";
                }
