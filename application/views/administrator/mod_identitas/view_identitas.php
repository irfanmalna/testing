<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/identitaswebsite',$attributes); 
              echo '<div class="col-md-12">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><input type="number" class="form-control" name="e" value="'.$record[rekening].'"></td>
                        </tr>
                        <tr>
                          <th scope="row">No Telpon</th>                    
                          <td><input type="number" class="form-control" name="f" value="'.$record[no_telp].'"></td></tr>   
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><input type="file" class="form-control" name="j" value="'.$record[favicon].'"><hr style="margin:5px">
                          Favicon Saat ini : <img style="width:32px; height:32px" src="'.base_url().'asset/images/'.$record[favicon].'"></td></tr>
                      </tbody>
                      </table>
                    </div>
                  <div class="box-footer">
                        <button type="submit" name="submit" class="btn btn-info">Update</button>
                        <a href="'.base_url().$this->router->fetch_class().'/identitaswebsite"><button type="button" class="btn btn-default pull-right">Cancel</button></a>
                      </div>
                </div></div></div>';
            echo form_close();
