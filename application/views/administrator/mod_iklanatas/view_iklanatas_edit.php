<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/edit_iklanatas',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Url</th>    <td><input type='url' class='form-control' name='b' value=\"".stripslashes($rows[url])."\" required></td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/iklanatas'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
