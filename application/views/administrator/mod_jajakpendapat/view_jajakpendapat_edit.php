<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/edit_jajakpendapat',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                    <tbody>
                      <input type='hidden' name='id' value='$rows[id_poling]'>
                       <tr><th scope='row' width='120px'>Pertanyaan</th> <td><input type='text' class='form-control' name='a' value=\"".stripslashes($rows[pilihan])."\" required></td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/jajakpendapat'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
