<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/edit_komentarberita',$attributes); 
          echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/komentarberita'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
