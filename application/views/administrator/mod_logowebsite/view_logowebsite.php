              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo form_open_multipart($this->router->fetch_class().'/logowebsite',$attributes); 
                    $no = 1;
                    ...
                    echo "<tr><td></td><td><div class='box-footer'>
                            ...
                            <a href='".base_url().$this->router->fetch_class()."/logowebsite'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
                          </div></td></tr>";
                    echo form_close();
                  ?>
                  </tbody>
