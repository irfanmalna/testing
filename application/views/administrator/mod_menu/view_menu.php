  ...
  $(document).ready(function(){
    ...
    $("#submit").click(function(){
       ...
       var dataString = { 
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url().$this->router->fetch_class(); ?>/save_menuwebsite",
            data: dataString,
            dataType: "json",
            cache : false,
    ...
    $(document).on("click",".pos-button",function() {
        var id = $(this).attr('id');
            $("#load").show();
             $.ajax({
                type: "POST",
                url: "<?php echo base_url().$this->router->fetch_class(); ?>/posisi_menuwebsite",
                data: { id : id },
                cache : false,
                success: function(data){
                  $("#load").hide();
    ...
    $(document).on("click",".del-button",function() {
        ...
        if(x){
            $("#load").show();
             $.ajax({
                type: "POST",
                url: "<?php echo base_url().$this->router->fetch_class(); ?>/delete_menuwebsite",
                data: { id : id },
                cache : false,
                success: function(data){
                  $("#load").hide();
