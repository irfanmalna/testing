<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/edit_manajemenmodul',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$rows[id_modul]'>
                    <tr><th width='120px' scope='row'>Nama Modul</th>   <td><input type='text' class='form-control' name='a' value=\"".stripslashes($rows[nama_modul])."\" required></td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/manajemenmodul'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
                  </div>
            </div></div></div>";
            echo form_close();
