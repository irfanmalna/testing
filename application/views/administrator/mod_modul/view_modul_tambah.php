    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Link</th>              <td style='color:red'><b>".base_url().$this->router->fetch_class()."/</b> <input type='text' class='form-control' name='b' style='width:50%; display:inline-block' required></td></tr>
