<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/edit_manajemenuser',$attributes); 
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input type='text' class='form-control' name='a' value=\"".stripslashes($rows[username])."\" readonly='on'></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input type='text' class='form-control' name='c' value=\"".stripslashes($rows[nama_lengkap])."\"></td>
                    </tr>
                    <tr>
                      <th scope='row'>Alamat Email</th>                    
                      <td><input type='email' class='form-control' name='d' value=\"".stripslashes($rows[email])."\"></td>
                    </tr>
                    <tr>
                      <th scope='row'>No Telepon</th>                  
                      <td><input type='number' class='form-control' name='e' value=\"".stripslashes($rows[no_telp])."\"></td>
                    </tr>
                    <tr>
                      <th scope='row'>Ganti Foto</th>                     
                      <td><input type='file' class='form-control' name='f'><hr style='margin:5px'>";
                    ...
                    if ($this->session->level == 'admin'){
                      echo "<tr>
                        ...
                        <td>"; if ($rows['blokir']=='Y'){ echo "<input type='radio' name='h' value='Y' checked> Ya &nbsp; <input type='radio' name='h' value='N'> Tidak"; }else{ echo "<input type='radio' name='h' value='Y'> Ya &nbsp; <input type='radio' name='h' value='N' checked> Tidak"; } echo "</td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/manajemenuser'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
                  </div>
            </div></div></div>";
            echo form_close();