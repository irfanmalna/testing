<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/tambah_manajemenuser',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input type='radio' name='g' value='kontributor' checked> Kontributor &nbsp; <input type='radio' name='g' value='user'> User Biasa &nbsp; <input type='radio' name='g' value='admin'> Administrator
                    <tr>
                      <th scope='row'>Akses Modul</th>                    <td><div class='checkbox-scroll'>";
