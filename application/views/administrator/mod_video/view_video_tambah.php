<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->router->fetch_class().'/tambah_video',$attributes); 
          echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->router->fetch_class()."/video'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
