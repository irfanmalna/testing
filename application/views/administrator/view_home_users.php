<?php
    ...
    echo "<div class='col-md-6'>
        ...
        $feedlist = new rss($_SERVER['HTTP_HOST'].'/forum.xml'); /* Ubah link feed disini dengan link feed Anda */
        echo $feedlist->display(5,"Posnetindo.co.id"); /* Angka 7 digunakan untuk menampilkan jumlah artikel */
    echo "</section>";