...
echo "<div class='widget'>
    <h3>Tentang Pelapak</h3>";
      ...
      <tbody>";
        if (trim($rows['foto'])==''){ $foto_user = 'blank_avatar.png'; }else{ $foto_user = $rows['foto']; }
...
<a class='btn btn-xs btn-block btn-success mt-3 p-1' href='".base_url()."produk/produk_reseller/$rows[id_reseller]'>Semua Produk</a>
<a class='btn btn-xs btn-block btn-info mt-2 p-1' href='".base_url()."produk/detail_reseller/$rows[id_reseller]'>Lihat Profile</a>
<a class='btn btn-xs btn-block btn-default mt-2 p-1' href=''>Jumlah Pelanggan <span class='badge'>".$pelanggan->num_rows()."</span></a>
<a class='btn btn-xs btn-block btn-default mt-2 p-1' href=''>Pesanan Diterima <span class='badge'>".$sukses->num_rows()."</span></a>
<a class='btn btn-xs btn-block btn-default mt-2 p-1' href=''>Bergabung <span class='badge'>".tgl_indo($ex[0])."</span></a>
