           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";                
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td><b>Nama Lengkap</b></td>           <td>".stripslashes($row[nama_lengkap])."</td></tr>
                          ...
                          <tr><td><b>Propinsi</b></td>               <td>".stripslashes($row['propinsi'])."</td></tr>
                          <tr><td><b>Kota</b></td>                   <td>".stripslashes($row['kota'])."</td></tr>
                          <tr><td><b>Kecamatan</b></td>              <td>".stripslashes($row[kecamatan])."</td></tr>
