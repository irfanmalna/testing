                  ...
                  echo '<table class="table table-hover table-condensed">
                        <thead>
                          <tr>
                              ...
                              <td><input class="required form-control" style="width:50%; display:inline-block" name="aa" type="text" value="'.$row[username].'"></td></tr>
                          <tr>
                              <td><b>Password</b></td>
                          ...
                          <tr>
                            ...
                            <td><input class="required form-control" type="text" name="b" value="'.stripslashes($row[nama_lengkap]).'"></td>
                          </tr>
                          <tr>
                            <td><b>Email</b></td>          
                            <td><input class="required email form-control" type="email" name="c" value="'.$row[email].'"></td>
                          </tr>
                          <tr>
                            <td><b>Jenis Kelamin</b></td>  
                            <td>'; if ($row['jenis_kelamin']=='Laki-laki'){ 
                          ...
                          <tr>
                            ...
                            <td><input class="required datepicker form-control" type="text" name="e" value="'.$row[tanggal_lahir].'" data-date-format="yyyy-mm-dd"></td>
                          </tr>
                          <tr>
                            <td><b>Tempat Lahir</b></td>   
                            <td><input class="required form-control" type="text" name="f" value="'.$row[tempat_lahir].'"></td>
                          </tr>
                          <tr>
                            <td><b>Alamat</b></td>         
                            <td><textarea class="required form-control" name="g">'.$row[alamat_lengkap].'</textarea></td>
                          </tr>
                          <tr>
