<p class='sidebar-title text-danger produk-title'>Detail Data Produk Pelapak</p>
    ...
    ?>
    <div class="p-4">
        <center><?php echo "<img style='border:1px solid #cecece; height:100px; width:100px' src='".base_url()."asset/foto_user/$foto_user' class='img-circle img-thumbnail'>"; ?></center>
    </div>
    <div>&nbsp;</div>
