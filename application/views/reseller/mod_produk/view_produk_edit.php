...
<?php 
    $_SESSION['produk_seo'] = $rows[produk_seo];
    $_SESSION['produk_id'] = $rows[id_produk];
    $_SESSION['harga_reseller'] = $rows[harga_reseller];
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input type='text' class='form-control' name='b' value=\"".stripslashes($rows[nama_produk])."\" required></td>
                    </tr>
                    <tr>
                      <th scope='row'>Satuan</th>                     
                      <td><input type='text' class='form-control' name='c' value=\"".stripslashes($rows[satuan])."\"></td>
                    </tr>
                    <tr>
                      <th scope='row'>Berat / Gram</th>                      
                      <td><input type='number' class='form-control' name='berat' value=\"".stripslashes($rows[berat])."\"></td>
                    </tr>
                    <tr>
                      <th scope='row'>Harga Modal</th>                 
                      <td><input type='number' class='form-control' name='d' value='$rows[harga_beli]'></td>
                    </tr>
                    <tr>
                      <th scope='row'>Harga Jual</th>             
                      <td><input type='number' class='form-control' name='f' value='$rows[harga_konsumen]'></td>
                    </tr>
                    <tr>
                      <th scope='row'>Diskon</th>                 
                      <td><input type='number' class='form-control' name='diskon' value='$disk[diskon]'></td>
                    </tr>
                    <tr>
                      <th scope='row'>Stok</th>                 
                      <td><input style='display:inline-block; width:80px; color:red' type='number' class='form-control' value='".($beli['beli']-$jual['jual'])."' disabled> + <input style='display:inline-block; width:80px' type='number' class='form-control' name='stok'> </td>
                    </tr>
                    <tr>
                      <th scope='row'>Keterangan</th>                 
                      <td><textarea class='textarea form-control' name='ff' style='height:180px'>$rows[keterangan]</textarea></td>
                    </tr>
                    <tr>
