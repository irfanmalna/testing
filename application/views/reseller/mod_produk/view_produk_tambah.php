    ...
    echo "<div class='col-md-12'>
          ...
          echo "<table class='table table-condensed table-bordered'>
                  <tbody>
                    ...
                    <td><input type='text' class='form-control' name='c' placeholder='pcs, unit'></td></tr>
                    <tr><th scope='row'>Berat / Gram</th>                      
                    <td><input type='number' class='form-control' name='berat'></td></tr>
                    ...
                    <td><input type='number' class='form-control' name='f'></td></tr>
                    <tr><th scope='row'>Diskon</th>                 
                    <td><input type='number' class='form-control' name='diskon'></td></tr>
                    <tr><th scope='row'>Stok Awal</th>                 
                    <td><input type='number' class='form-control' name='stok'></td></tr>
                    <tr><th scope='row'>Keterangan</th>                 
                    <td><textarea class='textarea form-control' name='ff' style='height:180px'></textarea></td></tr>
