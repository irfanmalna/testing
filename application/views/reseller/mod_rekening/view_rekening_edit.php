    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Nama Bank</th>    <td><input type='text' class='form-control' name='a' value=\"".stripslashes($rows[nama_bank])."\" required></td></tr>
                    <tr><th scope='row'>No Rekening</th>                 <td><input type='number' class='form-control' name='b' value='$rows[no_rekening]'></td></tr>
                    <tr><th scope='row'>Atas Nama</th>                   <td><input type='text' class='form-control' name='c' value=\"".stripslashes($rows[pemilik_rekening])."\"></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
