...
?>
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box-header">
              <i class="fa fa-th-list"></i>
              <h3 class="box-title">10 Pesanan Terbaru (Harus Diproses)</h3>
                  <div class="box-tools pull-right">
                     <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                      <button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
                  </div>
              ...
              <div class="box-body">
                <table class="table table-bordered table-striped table-condensed">
                  ...
                  <?php 
                    ...
                    if ($row['proses']=='0'){ 
                      ...
                      $proses = '<i class="text-success">Belum Diproses</i>'; 
                      $status = 'Pending'; 
                      $icon = 'star text-yellow'; 
                      $ubah = 0;                      
                    } elseif($row['proses']=='3'){
                ...
                <a class='btn btn-default btn-block' href='<?php echo base_url().$this->uri->segment(1); ?>/orderan'>Lihat Semua</a>
              </div>
              </div>
            </section>
