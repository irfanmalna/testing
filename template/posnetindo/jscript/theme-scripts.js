function spiner_overlay(t,msg){
  if(t==1){
    $('body').append('<div class="overlay" id="overley"><div class="spiner_center"><div class="spiners"></div><br/><h2 id="overlay_msg">'+msg+'</h2></div></div>');
  } else{
